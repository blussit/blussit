...
const IMG = {
  hero: "/hero-image.png",
  whyChoose: "/why-choose.png",
  howItWorks: "/how-works.png",
...
const HERO_SLIDES = [
...

  {
    ...
    titleAccent: "",
    description:
      "A quick premium clean for your everyday drive.",
    price: "₹350",
    oldPrice: "₹450",
    discount: "SAVE 22%",
    tag: "MOST POPULAR",
    note: "Car + Bike available",
    items: [
      "Exterior Wash Foam",
      "Interior Vacuum",
      "Dashboard Polish",
...

  {
    ...
    titleAccent: "",
    description:
      "A complete inside-out clean for a refreshed finish.",
    price: "₹699",
    oldPrice: "₹899",
    discount: "SAVE 22%",
    tag: "BEST VALUE",
    note: "Complete interior & exterior care",
    items: [
      "Exterior Wash Foam",
      "Interior Vacuum",
      "Seat Cleaning",
...

  {
    ...
    titleAccent: "",
    description:
      "Eco-friendly doorstep cleaning with a clean finish.",
    price: "₹499",
    oldPrice: "₹599",
    discount: "SAVE 17%",
    tag: "ECO FRIENDLY",
    note: "Eco-friendly doorstep service",
    items: [
      "Exterior Wash",
      "Interior",
      "Dashboard Polish",
...

  {
    ...
    titleAccent: "",
    description:
      "Add your bike to the same doorstep visit.",
    price: "₹400",
    oldPrice: "",
    discount: "COMBO",
    tag: "CAR + BIKE",
...
const TRUST_ITEMS = [
  ...
  },
  {
    ...
    sub: "Punctual & Reliable",
  },
  {
    icon: BadgeCheck,
    label: "Premium Quality",
    sub: "Best-in-class care",
  },
  {
    icon: IndianRupee,
...
export function LandingHero({
    ...
    <section className="bg-white">
      ...
      >
        ...
        <div className="container-page relative z-10 flex h-full flex-col justify-center px-5 pb-16 pt-12 sm:px-8 sm:pb-56 sm:pt-14 lg:px-0 lg:pb-24">
          ...
          {/* Shared benefit strip: deliberately present for every campaign slide. */}
          <motion.div
              key={`benefits-${slide.id}`}
              initial={{
                opacity: 0,
                y: 14,
              }}
  ...
  {HERO_SLIDES.map((heroSlide, index) => (
    ...
    />
      ...
      <div className="relative z-30 grid grid-cols-2 gap-2 border-t border-black/5 bg-white px-5 py-4 sm:grid-cols-3 lg:hidden">
        ...
        {TRUST_ITEMS.map((t) => (
          ...
          >
            ...
            <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#FFF4CD] text-black">
            ...
            <div className="leading-tight">
              ...
              <span className="block text-[8px] font-medium text-neutral-500">
                {t.sub}
              </span>
  ...
  const displayServices =
    apiServices.length > 0
      ...
      : SERVICE_CARDS.map((service) => ({
          ...service,
          image: IMG.services[SERVICE_CARDS.indexOf(service) % IMG.services.length],
        }));
