...
export function WhatsAppFloatingButton() {
  ...
  return (
    <div
      ...
      className={`z-[99999] flex flex-col items-end gap-3 transition-opacity duration-200 ${overFooter ? "pointer-events-none opacity-0" : "opacity-100"}`}
      style={{
        position: "fixed",
        right: "24px",
        bottom: "24px"
    ...
    >
      <a
        ...
        className="group flex h-[54px] flex-row items-center gap-2 outline-none sm:h-[58px]"
      >
        ...
        <span className="animate-call-ring flex h-[54px] w-[54px] shrink-0 items-center justify-center rounded-full border-2 border-white/90 bg-[#2563EB] text-white shadow-[0_8px_24px_rgba(0,0,0,0.25)] transition-[transform,box-shadow] duration-200 sm:h-[58px] sm:w-[58px] group-hover:scale-[1.08] group-hover:shadow-[0_10px_28px_rgba(0,0,0,0.32)]">
      ...
      >
        ...
        <span className="flex h-[54px] w-[54px] shrink-0 items-center justify-center rounded-full border-2 border-white/90 bg-[#25D366] text-white shadow-[0_8px_24px_rgba(0,0,0,0.25)] transition-[transform,box-shadow] duration-200 group-hover:scale-[1.08] group-hover:shadow-[0_10px_28px_rgba(0,0,0,0.32)] sm:h-[58px] sm:w-[58px]">
